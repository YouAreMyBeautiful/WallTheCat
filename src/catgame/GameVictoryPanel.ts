 ...
 *
 */
class GameVictoryPanel extends egret.Sprite{
    private gameVictoryBitmap = new egret.Bitmap();
    ...
    private arr1:string[] = ["绝世神经高人","神精病博士","神经大神","你是我的小苹果","院长派来的救兵","精神病院长","扫地僧","传说中的高手","风骚的少年","你家里人知道吗","隔壁老王"];
    private arr2:string[] = ["就是这么任性","不作死就不会死","根本停不下来","且行且珍惜","我是猴子请来的","然而并没有什么卵用","也是蛮拼的","只想安静地做个美男子","你是汪星人吗"];
    public replay: RePlay=new RePlay();
     public constructor(total:number) {
        ...
        var msg: String = new String(this.total);
